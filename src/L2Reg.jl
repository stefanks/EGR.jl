function L2regGradient(gradientOracle::Function, L2param::Float64, W::Vector{Float64}, index::Int64)
	(f,g,ym) = gradientOracle(W,index)
	newG = g+ L2param*W
	(f + (1/2)*L2param*norm(W)^2, newG, newG)
end

function L2regGradient(gradientOracle::Function, L2param::Float64, W::Vector{Float64})
