function LoadTestAgaricusData(Oracles)
	...
	for L2reg in L2regs
		...
		push!(Oracles, (gradientOracle, numVars, numTrainingPoints, restoreGradient, csDataType, LossFunctionString, myOutputter, L2reg, (t)-> Problem(L2reg, "TestAgaricus", LossFunctionString, (w)->gradientOracle(w), numTrainingPoints, t),numVars))
