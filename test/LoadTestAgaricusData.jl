function LoadTestAgaricusData(Oracles)
	...
	for L2reg in L2regs
		...
		push!(Oracles, (gradientOracle, numVars, numTrainingPoints, restoreGradient, csDataType, LossFunctionString, myOutputter, L2reg,  "TestAgaricus", (t)-> Problem(L2reg, "TestAgaricus", LossFunctionString, (w)->gradientOracle(w), numTrainingPoints, t,(j)->getSampleFunctionAt(j,gradientOracle,restoreGradient)),numVars))
		...
		push!(Oracles,(gradientOracle2, numVars2, numTrainingPoints2, restoreGradient2, csDataType2, LossFunctionString2, myOutputter2, L2reg2, "TestAgaricus", (t)-> Problem(L2reg2, "TestAgaricus", LossFunctionString2, (w)->gradientOracle2(w), numTrainingPoints2, t,(j)->getSampleFunctionAt(j,gradientOracle,restoreGradient)),numVars2))
	end
end
